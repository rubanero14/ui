    ...
    return <div className={s['container']}>
        <div className={s['transfer-calculator']}>
            ...
            >
                ...
                >
                    <svg width="16" height="16" fill="currentColor" focusable="false" viewBox="0 0 24 24"><path d="m22.029 11.572-6-6-1.2 1.2 4.543 4.543H4.629l4.543-4.543-1.2-1.2-6 6a.829.829 0 0 0 0 1.2l6 6 1.2-1.2-4.543-4.543h14.7l-4.5 4.543 1.2 1.2 6-6a.829.829 0 0 0 0-1.2Z"></path></svg>
                </button>
                <fieldset className={s['input__wrapper']}>
                    <input 
                        type="text"
